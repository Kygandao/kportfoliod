...
const Infobar = () => {
    ...
    return (
        <div>
            ...
            <p className='px-2 py-1 my-3 text-sm bg-gray-300 rounded-xl dark:bg-gray-800'>Full Stack Developer</p>
            ...
            {/* LOCATION */}
            <div className='py-4 my-5 bg-gray-300 dark:bg-gray-800 rounded-xl' style={{marginLeft:'-.5rem', marginRight:'-.5rem'}}>

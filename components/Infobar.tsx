...
const Infobar = () => {
    ...
    return (
        <div>
            ...
            <a href='/resume/KyganDaoResume4.22.pdf' download='KyganDaoResume.pdf' className='w-8/12 px-3 py-1 my-1 text-white bg-green-900 shadow-xl rounded-xl hover:bg-green-700 dark:bg-black dark:hover:bg-gray-800'>Download Resume</a>

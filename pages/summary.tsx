...
const summary = () => {
    return (
        <div className='px-6 py-2 '>
            <div className='grid gap-5 px-4 pt-1 bg-gray-300 md:grid-cols-2' style={{marginLeft:'-1rem', marginRight:'-1rem'}}>
                <div id='education'>
                    <h5 className='my-2 text-lg font-semibold text-green-900 font-rock'>Education</h5>
                    <div>
                        <div className='p-1 my-1 space-x-5 bg-gray-200 rounded-md'>

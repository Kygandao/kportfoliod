                ...
                id='education'>
                    ...
                    <div>
                        <div className='p-1 my-1 space-x-5 bg-gray-300 rounded-md shadow-xl dark:bg-black bg-opacity-60'>
                            <h5 className='my-1 font-semibold'>Java Development Bootcamp</h5>
                            <p className='italic'>Southern Methodist University</p>
                        </div>
                        <div className='p-1 my-1 space-x-5 bg-gray-300 rounded-md shadow-xl dark:bg-black bg-opacity-60'>
                            <h5 className='my-1 font-semibold'>Full Stack Web Development Bootcamp</h5>
                            <p className='italic'>University of Oregon</p>
                        </div>
                        <div className='p-1 my-1 space-x-5 bg-gray-300 rounded-md shadow-xl dark:bg-black bg-opacity-60'>
                            <h5 className='my-1 font-semibold'>Bachelor of Science - Graphic Design</h5>
